  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${serverURL_USERS}`, // ex: http://localhost:5000/api/users
        formData,
        {
          headers: {
      ...
      toast.success("Formateur créé avec succès", {
        description:
          data?.message || "Le formateur sera créé dans quelques secondes",
        action: { label: "✖️" },
      });
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-star justify-center gap-5">
            <Sidebar />
