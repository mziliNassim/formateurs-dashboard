const PASSWORD_WELCOME_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <link href="  <link href="URL_ADDRESS.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
</head>
  ...
  <div style="margin: 20px;">
    ...
    <div style="background: linear-gradient(135deg, #6a3de8, #9d41e0); padding: 30px 20px; text-align: center; border-radius: 12px 12px 0 0;">
      <div style="font-size: 28px; color: white; margin-bottom: 5px;">
        <i class="fas fa-user-plus" style="margin-right: 10px;"></i>Welcome to our Website
      </div>
      <p style="color: rgba(255, 255, 255, 0.9); margin: 0; font-size: 16px;">Your journey begins here</p>
    </div>
    ...
    <div style="background-color: white; padding: 35px 30px; border-radius: 0 0 12px 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
      <p style="font-size: 17px;">Hi {fName} {lName},</p>

      <!-- Visual separator -->
      <div style="width: 60px; height: 5px; background: linear-gradient(to right, #6a3de8, #9d41e0); margin: 20px 0;"></div>
      <p style="font-size: 16px; color: #555;">We're excited to have you on board. Your account has been successfully created.</p>

      <!-- Info box -->
      <div style="background-color: rgba(106, 61, 232, 0.05); border-left: 4px solid #6a3de8; padding: 15px; margin: 25px 0; border-radius: 0 8px 8px 0;"></div>
        <p style="margin: 0; color: #444;">Your role: <strong>{role}</strong></p>
      </div>
  ...
  <div style="margin: 20px;">
    ...
    <div style="text-align: center; margin-top: 25px; color: #999; font-size: 14px;">
      ...
      <div style="margin-top: 15px;">
        <a href="{clientURL}contact-us" style="color: #6a3de8; text-decoration: none; margin: 0 10px;">Contact Us</a>
        <a href="{clientURL}privacy-policy" style="color: #6a3de8; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
      </div>
    </div>
